...
class ExampleWindow:
	...
	def __init__(self):
		...
		# tab3 = gui.Vert()
		# tab3.add_child(gui.Button("Apple"))
		# tab3.add_child(gui.Button("Orange"))
		...
		tab4.set_items(["Airplane", "Train", "Bus"])
		# tab4 = gui.Horiz()
		# tab4.add_child(gui.Button("Airplane"))
		# tab4.add_child(gui.Button("Train"))
		# tab4.add_child(gui.Button("Bus"))
